...
const RulesDialog = () => {
  return (
    <Dialog>
      <DialogTrigger>
        <Button variant="default">Rules</Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
        ...
        <DialogDescription>
          ...
          <ul>
            <li>
              ...
              enter. Tokens can be purchased or earned through various
            ...
            <li>
              ...
              immediate disqualification and potential banning from future
              games.
            </li>
            <li>
          ...
          <p>
            The AI’s rating is final and based on complex algorithms. It might
            not always align with human judgment or preference. The nature of AI
            rating means that there can be an element of unpredictability,
            making each game uniquely exciting.
          </p>
          <p>
